					...
					<form action="notice_add" method="post">
						...
						<div class="panel panel-flat">
							<div class="panel-heading">
								<h5 class="panel-title">Notice Title</h5>
								<div class="heading-elements">
									<ul class="icons-list">
							...
							<div class="panel-body">
								<p class="content-group">Notice's title!</p>
								<div class="content-group">
									<input type="text" class="form-control"
										placeholder="notice's title" name="notice_title" />
								</div>
							</div>
						</div>
						<!-- CKEditor default -->
						<div class="panel panel-flat">
							<div class="panel-heading">
								<h5 class="panel-title">Notice Description</h5>
								<div class="heading-elements">
									<ul class="icons-list">
										<li><a data-action="collapse"></a></li>
										<li><a data-action="reload"></a></li>
							...
							<div class="panel-body">
								<p class="content-group">Describe details about your notice</p>

								<div class="content-group">
									<textarea name="notice_description" id="editor-full" rows="4"
										cols="4"></textarea>
