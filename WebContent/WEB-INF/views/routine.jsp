...
<script type="text/javascript"
	src="resources/assets/js/plugins/ui/fullcalendar/fullcalendar.min.js"></script>

<script type="text/javascript" src="resources/assets/js/core/app.js"></script>
<script type="text/javascript"
	src="resources/assets/js/pages/extra_fullcalendar.js"></script>
						...
						<div class="page-title">
							<h4>
								<i class="icon-arrow-left52 position-left"></i> <span
									class="text-semibold">Fullcalendar</span> - Styling
							</h4>
						</div>
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							<p class="content-group">
								FullCalendar allows you to change the color of all events on the
								calendar using the
								<code>eventColor</code>
								option. Also you can change text, border and background colors
								for events in a specific Event Source with
								<code>event source</code>
								options (backgroundColor, color, textColor and borderColor) and
								for individual events with
								<code>color</code>
								option, which sets an event's background and border color.
								Example below demonstrates event colors based on a day of the
								week.
							</p>
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							<p class="content-group">
								...
								setting an Event Object's
								<code>rendering</code>
								property to
								<code>background</code>
								. Background events that are <span class="text-semibold">timed</span>
								will only be rendered on the time slots in agenda view.
								Background events that are <span class="text-semibold">all-day</span>
								will only be rendered in month view or the all-day slots of
								agenda view. Also the spans of time <span class="text-semibold">not</span>
								occupied by an event can be colored by setting the
								<code>rendering</code>
								property to
								<code>inverse-background</code>
								.
							</p>
