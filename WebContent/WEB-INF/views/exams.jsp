			...
			<div class="content-wrapper">
						...
						<div class="page-title">
							<h4>
								<i class="icon-arrow-left52 position-left"></i> <span
									class="text-semibold">Tables</span> - Basic
							</h4>
						</div>
				...
				<div class="content">
					...
					<h6 class="content-group text-semibold">
						Basic tables <small class="display-block">Tables with
							default <code>Bootstrap</code> styling
						</small>
					</h6>
					<!-- /basic tables title -->
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							Example of a
							<code>basic</code>
							table. For basic styling (light padding and only horizontal
							dividers) add the base class
							<code>.table</code>
							to any
							<code>&lt;table&gt;</code>
							. It may seem super redundant, but given the widespread use of
							tables for other plugins like calendars and date pickers, we've
							opted to isolate our custom table styles.
						</div>
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							<code>:nth-child</code>
							CSS selector isn't supported in these browser versions. Striped
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							to the base
							<code>.table</code>
							class for borders on all sides of the table and cells. This is a
							default Bootstrap option for the table, for more advanced border
							options check <a href="table_borders.html">Table borders</a>
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							classes to the base
							<code>.table</code>
							class for borders and row striping. This method works with all
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							table. To use a fixed height with scrolling, wrap any table in a
							div with
							<code>.pre-scrollable</code>
							class. Max height of the table container will be
							<code>340px</code>
							and table will get a vertical scrollbar if its height is move
							than this value.
						</div>
					...
					<h6 class="content-group text-semibold">
						Panel body tables <small class="display-block">Tables
							placed inside <code>panel body</code>.
						</small>
					</h6>
					<!-- /panel body tables title -->
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							<p class="content-group">
								Example of a table placed inside
								<code>panel body</code>
								. Such tables always have additional whitespace taken from
								<code>.panel-body</code>
								element padding.
							</p>
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							<p class="content-group">
								Example of
								<code>framed</code>
								table inside panel body. Tables that placed inside panel body
								don't have border around them by default,
								<code>.table-framed</code>
								class adds border around the table.
							</p>
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							<p class="content-group">
								Example of
								<code>bordered framed</code>
								table inside panel body. By default bordered table also doesn't
								have a border, to use border around the bordered table add
								<code>.table-framed</code>
								to the
								<code>&lt;table></code>
								.
