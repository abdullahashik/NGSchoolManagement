<%@page import="com.loopbreak.entities.Students"%>
						...
						<div class="page-title">
							<h4>
								<i class="icon-arrow-left52 position-left"></i> <span
									class="text-semibold">Search</span> - Students
							</h4>

							<ul class="breadcrumb position-right">
								<li><a href="dashboard.jsp">Home</a></li>
								<li><a href="search_users.html">Students</a></li>
										...
										<div class="col-sm-4">
											<div class="panel panel-body">
												<div class="media">
													...
													<div class="media-body">
														<h6 class="media-heading">${student.getFname()}
															${student.getMname() } ${student.getLname() }</h6>
														<span class="text-muted">${student.getStudentId() }</span>
													</div>
															...
															<li class="dropdown"><a href="#"
																...
																<ul class="dropdown-menu dropdown-menu-right">
																	<li><a href="#"><i
																			...
																			Student</a></li>
																	<li><a href="students/${student.getId() }"><i
