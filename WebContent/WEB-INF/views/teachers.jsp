<%@page import="com.loopbreak.entities.Staff"%>
						...
						<div class="page-title">
							<h4>
								<i class="icon-arrow-left52 position-left"></i> <span
									class="text-semibold">Search</span> - User Results
							</h4>
				...
				<div class="content">
										...
										<ul class="list-inline list-inline-condensed no-margin-bottom">
											<li class="dropdown"><a href="#"
												...
												data-toggle="dropdown"> <i
													class="icon-stack2 position-left"></i> All categories <span
													class="caret"></span>
											</a>
												...
												<ul class="dropdown-menu">
													...
													<li><a href="#"><i class="icon-accessibility"></i>
															Registration</a></li>
													<li><a href="#"><i class="icon-reading"></i>
															General info</a></li>
													<li><a href="#"><i class="icon-gear"></i> Your
															settings</a></li>
					...
					<div class="content-group">
						<p class="text-muted text-size-small content-group">About
							827,000 results (0.34 seconds)</p>
										...
										<div class="col-sm-4">
											<div class="panel panel-body">
												<div class="media">
													...
													<div class="media-body">
														<h6 class="media-heading">${teacher.getName()}</h6>
														<span class="text-muted">${teacher.getEmail() }</span>
													</div>
														...
														<ul class="icons-list">
															<li class="dropdown"><a href="#"
																...
																<ul class="dropdown-menu dropdown-menu-right">
																	<li><a href="#"><i
																			class="icon-comment-discussion pull-right"></i>Edit
																			Teacher</a></li>
																	<li><a href="students/${teacher.getId() }"><i
																			class="icon-phone2 pull-right"></i>View Detail</a></li>
																	<li><a href="#"><i
																			class="icon-mail5 pull-right"></i>Results</a></li>
																	<li class="divider"></li>
																	<li><a href="#"><i
																			class="icon-statistics pull-right"></i>Payments</a></li>
																</ul></li>
														</ul>
													</div>
												</div>
