...
public class PostHome {
	...
	protected SessionFactory getSessionFactory() {
		try {
			sessionFactory = new Configuration().configure().addAnnotatedClass(Post.class).buildSessionFactory();
	...
	public Post findById(java.lang.Integer id) {
		...
		try {
			Post instance = (Post) sessionFactory.getCurrentSession().get("com.loopbreak.entities.Post", id);
			if (instance == null) {
	...
	public List<Post> findByExample(Post instance) {
		...
		try {
			List<Post> results = (List<Post>) sessionFactory.getCurrentSession()
					.createCriteria("com.loopbreak.entities.Post").add(create(instance)).list();
